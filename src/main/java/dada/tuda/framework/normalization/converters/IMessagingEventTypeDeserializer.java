...
public class IMessagingEventTypeDeserializer extends JsonDeserializer<IMessagingEventType> {
    ...
    public static final List<IMessagingEventType> MESSAGING_EVENT_TYPES = new ArrayList<>();
    ...
    public IMessagingEventType deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        //if (Arrays.stream(MessagingEventType.values()).anyMatch(e -> e.name().equals(text))) {
        //    return MessagingEventType.valueOf(text);
        //} else {
