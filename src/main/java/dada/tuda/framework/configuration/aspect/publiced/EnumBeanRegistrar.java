...
public class EnumBeanRegistrar implements ImportBeanDefinitionRegistrar, Ordered {
    @Override
    public void registerBeanDefinitions(@NotNull AnnotationMetadata importingClassMetadata, @NotNull BeanDefinitionRegistry registry) {
        ...
        Set<Class<?>> annotatedClasses = reflections.getTypesAnnotatedWith(EnumBean.class);
